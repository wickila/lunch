...
ALTER TABLE `lunch`.`user` DROP COLUMN `mobile`,
 DROP COLUMN `telephone`,
 DROP COLUMN `adress1`,
 DROP COLUMN `adress2`,
 ADD COLUMN `restnum` INT UNSIGNED NOT NULL AFTER `gender`;
ALTER TABLE `lunch`.`restuarant` ADD COLUMN `totalensure` INT UNSIGNED NOT NULL AFTER `created_time`,
